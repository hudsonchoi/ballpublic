    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
	    ...
	    -->
           ...
           <% If Session("MemberData").Item("restricted") Then %>	
            ...
            <div class="sitelet"><div class="new"><img src="./images/access/new.png" /></div><a href="handler.ashx?section=playball&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('playball','','./images/access/playball_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/playball.jpg" name="playball" width="410" height="51" border="0" id="playball"></a></div>
            <% End If %>
