...
<!--
    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
            ...
            <div class="sitelet"><a href="handler.ashx?section=mlb2016&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('clubmarksNew','','./images/access/marks16_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/marks16.jpg" name="clubmarksNew" width="410" height="51" border="0" id="clubmarksNew"/></a></div>
            <% End If%>
            ...
            <div class="sitelet"><div class="new"><img src="./images/access/new.png" /></div><a href="handler.ashx?section=world&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('post','','./images/access/post_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/post.jpg" name="post" width="410" height="51" border="0" id="post"></a></div>
            <% End If %>
