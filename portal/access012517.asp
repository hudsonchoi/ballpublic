...
<!--
    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
            ...
            <div class="sitelet"><div class="new"><img src="./images/access/new.png" /></div><a href="handler.ashx?section=mlb2017&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('clubmarksNew','','./images/access/marks17_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/marks17.jpg" name="clubmarksNew" width="410" height="51" border="0" id="clubmarksNew"/></a></div>
            <% End If%>
            
            <% If Session("MemberData").Item("mlb2016") Then %> 
            <div class="sitelet"><a href="handler.ashx?section=mlb2016&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('clubmarks','','./images/access/marks16_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/marks16.jpg" name="clubmarks" width="410" height="51" border="0" id="clubmarks"/></a></div>
            <% End If%>
            ...
            <div class="sitelet"><div class="new"><img src="./images/access/new.png" /></div><a href="handler.ashx?section=minor&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('minor','','./images/access/minor_h.png',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/minor.png" name="minor" width="410" height="51" border="0" id="minor"></a></div>
            <% End If %>
