...
public class Handler : IHttpHandler, IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
		...
		if ((context.Request.QueryString["section"] != null)&&(context.Request.QueryString["email"] != null)&&(context.Request.QueryString["guid"] != null)){
            if (context.Request.QueryString["section"] == "mlb")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://clubmarks.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "spring")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://springtraining.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            ...
            else if (context.Request.QueryString["section"] == "opening")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://openingday.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);    
            }
            else if (context.Request.QueryString["section"] == "alls")
            {
                ...
                context.Response.Redirect("framesetasg2.asp?target=http://allstargame.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world")
            {
                ...
                context.Response.Redirect("framesetpost2.asp?target=http://postseason.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "coop")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://cooperstown.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "mascot")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://mascots.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "minor")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://minorleague.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "club")
            {
                ...
                context.Response.Redirect("frameset2.asp?target=http://clubmarketingcenter.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
