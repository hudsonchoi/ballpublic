...
<body bgcolor="#003366" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onLoad="MM_preloadImages(
    ...
    'images/PSArc_00_OFF.gif','images/PSArc_00_ON.gif',
    'images/PSArc_01_OFF.gif','images/PSArc_01_ON.gif',
    'images/PSArc_02_OFF.gif','images/PSArc_02_ON.gif',
    'images/PSArc_03_OFF.gif','images/PSArc_03_ON.gif',
    'images/PSArc_04_OFF.gif','images/PSArc_04_ON.gif',
    'images/PSArc_05_OFF.gif','images/PSArc_05_ON.gif',
    'images/PSArc_06_OFF.gif','images/PSArc_06_ON.gif',
    'images/PSArc_07_OFF.gif','images/PSArc_07_ON.gif',
    'images/PSArc_08_OFF.gif','images/PSArc_08_ON.gif',
    'images/PSArc_09_OFF.gif','images/PSArc_09_ON.gif',
    'images/PSArc_10_OFF.gif','images/PSArc_10_ON.gif',
    'images/PSArc_11_OFF.gif','images/PSArc_11_ON.gif',
    'images/PSArc_12_OFF.gif','images/PSArc_12_ON.gif',
    'images/PSArc_13_OFF.gif','images/PSArc_13_ON.gif',
    'images/PSArc_14_OFF.gif','images/PSArc_14_ON.gif',
    'images/PSArc_15_OFF.gif','images/PSArc_15_ON.gif',
    'images/gnav_14ClubMarks_ON.gif','images/gnav_14ClubMarks_RO.gif','images/gnav_14ClubMarks_ONRO.gif',
    'images/gnav_15ClubMarks_ON.gif','images/gnav_15ClubMarks_RO.gif','images/gnav_15ClubMarks_ONRO.gif',
    ...
    <td><table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <%REM ATTENTION! ATTENTION! ATTENTION!
            REM When launching 2017 replace the below to Session("MemberData").Item("mlb2017") %>
		  <% If Session("MemberData").Item("mlb2016") Then %>
		<td><a href="handler.ashx?section=mlb2016&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top"  onClick="MM_nbGroup('down','group1','clubmarksNew','images/gnav_16ClubMarks_ON.gif',1);if(this.blur)this.blur();MM_showHideLayers('allsarchive','','hide')" onMouseOver="MM_nbGroup('over','clubmarksNew','images/gnav_16ClubMarks_RO.gif','images/gnav_16ClubMarks_ONRO.gif',1)" onMouseOut="MM_nbGroup('out')"><img name="clubmarksNew" src="images/gnav_16ClubMarks_OFF.gif" border="0" width="129" height="22"></a></td>
          <td><img src="images/nav_pipe.gif" width="2" height="22"></td>
        <%REM ATTENTION! ATTENTION! ATTENTION!
          REM  When launching 2017 replace the below to Session("MemberData").Item("mlb2016") AND update the button graphics%>
        <% End If %>
        <% If Session("MemberData").Item("mlb2015") Then%>
		<td><a href="handler.ashx?section=mlb2015&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top"  onClick="MM_nbGroup('down','group1','mlb1','images/gnav_15ClubMarks_ON.gif',1);if(this.blur)this.blur();MM_showHideLayers('allsarchive','','hide')" onMouseOver="MM_nbGroup('over','mlb1','images/gnav_15ClubMarks_RO.gif','images/gnav_15ClubMarks_ONRO.gif',1)" onMouseOut="MM_nbGroup('out')"><img name="mlb1" src="images/gnav_15ClubMarks_OFF.gif" border="0" width="129" height="22"></a></td>
          <td><img src="images/nav_pipe.gif" width="2" height="22"></td>
		<% End If %>
