...
public class Handler : IHttpHandler, IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
		...
		if ((context.Request.QueryString["section"] != null)&&(context.Request.QueryString["email"] != null)&&(context.Request.QueryString["guid"] != null)){
            if (context.Request.QueryString["section"] == "mlb2016")
            {
                ...
                context.Response.Redirect("frameset.asp?target=https://clubmarks.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "mlb2015")
            {
                if (context.Session["mlb_login"] == null)
                {
                    LogThisLogin(context);
                ...
                context.Response.Redirect("frameset.asp?target=https://clubmarks.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "spring")
            {
                ...
                context.Response.Redirect("frameset.asp?target=https://springtraining.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            ...
            else if (context.Request.QueryString["section"] == "opening")
            {
                ...
                context.Response.Redirect("frameset.asp?target=https://openingday.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);    
            }
            else if (context.Request.QueryString["section"] == "alls")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=https://allstargame.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            }
			else if (context.Request.QueryString["section"] == "alls2015")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=https://allstargame.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }    
            else if (context.Request.QueryString["section"] == "alls2014")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=https://allstargame.mlbstyleguide.com/sitelet/2014?token=" + context.Request.QueryString["guid"]);
            }    
            else if (context.Request.QueryString["section"] == "alls2013")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=https://allstargame.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world2013")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=https://postseason.mlbstyleguide.com/sitelet/2013?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world2014")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=https://postseason.mlbstyleguide.com/sitelet/2014?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world2015")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=https://postseason.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=https://postseason.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            }
