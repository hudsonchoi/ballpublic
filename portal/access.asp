...
<!--
    ...
    <body onLoad="MM_preloadImages('./images/access/marks22_h.jpg','./images/access/marks22.jpg','./images/access/marks23_h.png','./images/access/marks23.png','./images/access/spring.jpg','./images/access/spring__h.jpg','./images/access/opening.jpg','./images/access/opening_h.jpg','./images/access/all.jpg','./images/access/all_h.jpg','./images/access/post.png','./images/access/post_h.png','./images/access/coop.jpg','./images/access/coop_h.jpg','./images/access/mascot.jpg','./images/access/mascot_h.jpg','./images/access/minor.png','./images/access/minor_h.png','./images/access/asg2024r.png','./images/access/asg2024r_h.png','./images/access/playball.jpg','./images/access/playball_h.jpg','./images/access/london.jpg','./images/access/london_h.jpg',,'./images/access/sponsors.jpg','./images/access/sponsors_h.jpg','./images/access/mexico.png','./images/access/mexico_h.png','./images/access/little_league.jpg','./images/access/little_league_h.jpg','./images/access/mlblogovault.jpg','./images/access/mlblogovault_h.jpg','./images/access/restricted4.jpg','./images/access/restricted4_h.jpg','./images/access/allem.png','./images/access/allem_h.png','./images/access/openingem.png','./images/access/openingem_h.png','./images/access/springem.png','./images/access/springem_h.png','./images/access/postem.png','./images/access/postem_h.png')">
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
           ...
           <% If Session("MemberData").Item("restricted") Then %>	
            <div class="sitelet"><a href="handler.ashx?section=restricted&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('restricted','','./images/access/asg2024r_h.png',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/asg2024r.png" name="restricted" width="410" height="51" border="0" id="restricted"></a></div>
            <% End If %>
