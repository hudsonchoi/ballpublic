    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
           ...
           <% If Session("MemberData").Item("restricted") Then %>	
            ...
            <div class="sitelet"><a href="handler.ashx?section=allscp&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('allscp','','./images/access/allscp_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/allscp.jpg" name="allscp" width="410" height="51" border="0" id="allscp"></a></div>
            <% End If %>

            <% If Session("MemberData").Item("openingcp") Then %>	
            <div class="sitelet"><a href="handler.ashx?section=openingcp&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('openingcp','','./images/access/openingcp_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/openingcp.jpg" name="openingcp" width="410" height="51" border="0" id="openingcp"></a></div>
            <% End If %>

            <% If Session("MemberData").Item("springcp") Then %>	
            <div class="sitelet"><a href="handler.ashx?section=springcp&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('springcp','','./images/access/springcp_h.jpg',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/springcp.jpg" name="springcp" width="410" height="51" border="0" id="springcp"></a></div>
            <% End If %>
