    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
            ...
            <% REM ATTENTION! ATTENTION! ATTENTION!
               REM When launching 2025 replace the below to Session("MemberData").Item("mlb2025") %>
		     <% If Session("MemberData").Item("mlb2024") Then %> 
            <div class="sitelet"><a href="handler.ashx?section=mlb2024&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('clubmarksNew','','./images/access/marks24_h.png',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/marks24.png" name="clubmarksNew" width="410" height="51" border="0" id="clubmarksNew"/></a></div>
            <% End If%>

		     <% If Session("MemberData").Item("mlb2023") Then %> 
            <div class="sitelet"><a href="handler.ashx?section=mlb2023&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('clubmarks','','./images/access/marks23_h.png',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/marks23.png" name="clubmarks" width="410" height="51" border="0" id="clubmarks"/></a></div>
            <% End If%>
