    ...
    <form method="post" action="/portal/xt_login.asp" name="login">
        <div id="access_panel">
           ...
           <% If Session("MemberData").Item("restricted") Then %>	
            ...
            <div class="sitelet"><div class="new"><img src="./images/access/new.png" /></div><a href="handler.ashx?section=restricted4&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onMouseOver="MM_swapImage('restricted4','','./images/access/tokyo_h.png',1)" onMouseOut="MM_swapImgRestore()" onClick="MM_swapImgRestore()"><img src="./images/access/tokyo.png" name="restricted4" width="410" height="51" border="0" id="restricted4"></a></div>
            <% End If %>
