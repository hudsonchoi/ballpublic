...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/nav_back.gif">
  <tr> 
    <td><table border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td><a href="handler.ashx?section=mlb&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top"  onClick="MM_nbGroup('down','group1','mlb1','images/gnav_14ClubMarks_ON.gif',1);if(this.blur)this.blur();MM_showHideLayers('allsarchive','','hide')" onMouseOver="MM_nbGroup('over','mlb1','images/gnav_14ClubMarks_RO.gif','images/gnav_14ClubMarks_ONRO.gif',1)" onMouseOut="MM_nbGroup('out')"><img name="mlb1" src="images/gnav_14ClubMarks_OFF.gif" border="0" width="129" height="22"></a></td>
          <td><img src="images/nav_pipe.gif" width="2" height="22"></td>
		<% End If %>
  ...
  <tr align="center">
	...
	<a href="/ws2006/content/default.asp" target="fbody" onClick="MM_nbGroup('down','group1','arc2006','images/PSArc_06_ON.gif',1);if(this.blur)this.blur()" onMouseOver="MM_nbGroup('over','arc2006','images/PSArc_06_ON.gif','images/PSArc_06_ON.gif',1)" onMouseOut="MM_nbGroup('out')"><img src="images/PSArc_06_OFF.gif" name="arc2006" width="111" border="0"></a><br/>
    ...
    <a href="handler.ashx?section=world2003&email=<%=Session("MemberData").Item("Email")%>&guid=<%=Session("Guid")%>" target="_top" onClick="MM_nbGroup('down','group1','arc2013','images/ASGArc_14_ON.gif',1);if(this.blur)this.blur()" onMouseOver="MM_nbGroup('over','arc2013','images/PSArc_13_ON.gif','images/PSArc_13_ON.gif',1)" onMouseOut="MM_nbGroup('out')"><img src="images/PSArc_13_OFF.gif" name="arc2013" width="111" border="0"></a>
    </td>
  </tr>
</table>
