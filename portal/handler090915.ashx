...
public class Handler : IHttpHandler, IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
		...
		if ((context.Request.QueryString["section"] != null)&&(context.Request.QueryString["email"] != null)&&(context.Request.QueryString["guid"] != null)){
            if (context.Request.QueryString["section"] == "mlb2015")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://clubmarks.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }
            ...
            else if (context.Request.QueryString["section"] == "spring")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://springtraining.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            ...
            else if (context.Request.QueryString["section"] == "opening")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://openingday.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);    
            }
            else if (context.Request.QueryString["section"] == "alls")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=http://allstargame.mlbstyleguide.com/sitelet/2016?token=" + context.Request.QueryString["guid"]);
            }
			else if (context.Request.QueryString["section"] == "alls2015")
            {
                ...
                context.Response.Redirect("framesetasg.asp?target=http://allstargame.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }    
            ...
            else if (context.Request.QueryString["section"] == "world2014")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=http://postseason.mlbstyleguide.com/sitelet/2014?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "world")
            {
                ...
                context.Response.Redirect("framesetpost.asp?target=http://postseason.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }
            ...
            else if (context.Request.QueryString["section"] == "minor")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://minorleague.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);
            }
            ...
            else if (context.Request.QueryString["section"] == "mascotbabies")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://mascotbabies.mlbstyleguide.com/sitelet/2014?token=" + context.Request.QueryString["guid"]);
            }
            else if (context.Request.QueryString["section"] == "pressbox")
            {
                ...
                context.Response.Redirect("frameset.asp?target=http://mlbpressbox.mlbstyleguide.com/sitelet/2015?token=" + context.Request.QueryString["guid"]);                
            }
